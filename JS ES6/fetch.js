...
const klikTombol = document.querySelector('.silahkan-cari');
klikTombol.addEventListener('click', function(){

    const masukanKeyword = document.querySelector('.input-keyword');
    fetch('http://www.omdbapi.com/?apikey=cdf617a3&s=' + masukanKeyword.value)
    ...
    .then (response => {
        ...
        detailButton.forEach(btn =>{
            btn.addEventListener('click', function(){
                ...
                fetch('http://www.omdbapi.com/?apikey=cdf617a3&i=' + imdbid)
                .then(response => response.json())
                .then(m =>{
                    const movieDetail = showMovieDetail(m);
